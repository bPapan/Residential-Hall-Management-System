 ...
 * Life sucks....
 */
package hall_management.gui.admin.changePassword;
...
public class Change_passController implements Initializable {
    ...
    private void handleUpdateButton(ActionEvent event) {
        try {
            ...
            String stmt = "SELECT USER_PASS FROM LOGIN WHERE USER_ID = '0'" ;
            String dbold = null ;
            ...
            stmt = "UPDATE LOGIN SET USER_PASS = '" + newPass + "' WHERE USER_ID = '0'" ;
