 ...
 * Life sucks....
 */
package hall_management.gui.hallAdmin.Notifications;
...
public class NotificationsController implements Initializable {
    ...
    @FXML
    private TableColumn<Notice_Info, String> nRoomCol;
    @FXML
    ...
    public void initNotificationsColumns() {
        ...
        nRoomCol.setCellValueFactory(new PropertyValueFactory<>("nroom"));
    ...
    public void loadNotificationsData() {
        ...
        try {
            ...
            String query = "SELECT * FROM NOTICE\n" +
                            "WHERE ADMIN_ID = '" + utilities.getHid() + "'" ;
